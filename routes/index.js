...
module.exports = function(){
	...
	app.get("/tendering_calculate_sales_price/:user_id/:rfq_lines_id/:product_design_id/:complexity_id", tendering_validation.tendering_calculate_sales_price, tendering_calls.tendering_calculate_sales_price);
